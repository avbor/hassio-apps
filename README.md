...
The app is built using the [avbor/telegram-bot-api](https://github.com/avbor/telegram-bot-api) image which uses the [official source](https://github.com/tdlib/telegram-bot-api).

[releases-shield]: https://img.shields.io/github/v/release/avbor/hassio-apps.svg
